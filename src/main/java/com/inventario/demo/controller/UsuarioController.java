...
public class UsuarioController {
	...
	public ResponseEntity<?> buscarNombreDeUsuariAutenticado(Authentication authentication){
		...
		try {
			...
			//return new ResponseEntity<>(nombreUsuarioAutenticado, HttpStatus.OK); // esto nos devuelve el nombre el json pero solo el nombre plano
	...
	public ResponseEntity<?> getToken(@RequestBody UsuarioDTO usuarioDTO) {		
		Authentication authenticate = authenticationManager.authenticate(new UsernamePasswordAuthenticationToken(usuarioDTO.getUsername(), usuarioDTO.getPassword()));
